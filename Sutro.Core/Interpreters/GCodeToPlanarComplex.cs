...
namespace Sutro.Core.Interpreters
{
    public class GCodeToPlanarComplex : IGCodeListener
    {
        ...
        private int find_arc_centers(Vector2d p1, Vector2d p2, double radius, out Vector2d c0, out Vector2d c1)
        {
            c0 = c1 = Vector2d.Zero;
        ...
        private double arc_angle_deg(Vector2d p, Vector2d c)
        {
            Vector2d v = p - c;
            v.Normalize();
        ...
        private bool arc_is_cw(Vector2d p1, Vector2d p2, Vector2d c)
        {
            return false;
        }
