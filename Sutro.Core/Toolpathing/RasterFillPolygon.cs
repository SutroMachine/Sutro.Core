...
namespace Sutro.Core.Toolpathing
{
    public class RasterFillPolygon : ICurvesFillPolygon
    {
        ...
        private int find_nearest_span_endpoint(List<Segment2d> spans, Vector2d prev, out bool reverse)
        {
            reverse = false;
            int N = spans.Count;
            int iNearest = -1;
        ...
        /// </summary>
        private List<double> extract_valid_segments(GeneralPolygon2d poly, Segment2d ray, List<double> hits)
        {
